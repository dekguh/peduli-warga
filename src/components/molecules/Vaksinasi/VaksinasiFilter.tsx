...
import { updateVaksinasiSearchDistrict, updateVaksinasiSearchProvince } from '../../utils/redux/search/SearchAction'

const mapDispatchToProps = {
    updateSearchProvinceAct: (search: string) => (updateVaksinasiSearchProvince(search)),
    updateSearchDistrictAct: (search: string) => (updateVaksinasiSearchDistrict(search))
}
...
const VaksinasiFilter: React.FC<Props> = ({ updateSearchProvinceAct, updateSearchDistrictAct }) => {
...
export default connector(VaksinasiFilter)
